(() => {
    ...
    const app_images = document.querySelectorAll(".portfolio__block img");
    if (wrapper) {
        ...
        function animate() {
            if (!isDragging) targetPosition -= speed;
        ...
        function startDrag(e) {
            isDragging = true;
            startX = getPositionX(e) - position;
        ...
        function onDrag(e) {
            ...
            targetPosition = currentX - startX;
        }
        function stopDrag() {
            isDragging = false;
